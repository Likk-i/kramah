...
if (mysqli_connect_error()) {
    ...
    $q = "DELETE FROM student.objective WHERE objective.id='$deleteid'";
    $r = mysqli_query($conn, $q);
    $q1 = "DELETE FROM nba.objective WHERE objective.id='$deleteid'";
...
<table id="myTable">
    ...
    <?php while ($row = mysqli_fetch_assoc($r)) : ?>
        <tr>
            ...
            <td><strong><?php echo $row['core_values']; ?></strong></td>
           
            <td><form method="POST" style="display: inline;" action="edit4.php">
...
<form method="post" action="button4.php">
