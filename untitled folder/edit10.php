...
<table id="myTable">
    ...
    <?php while ($row = mysqli_fetch_assoc($r)) : ?>
        <tr>
            ...
            <td><strong><?php echo $row['credits']; ?></strong></td>
           
           
            <td><form method="POST" style="display: inline;" action="edit11.php">
...
<form method="post" action="button10.php">
