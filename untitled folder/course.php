...
if (mysqli_connect_error()) {
    ...
    $q = "DELETE FROM program WHERE id='$deleteid'";
...
<table id="myTable">
    <tr>
        ...
        <th>Practical hours</th>
         <th>Credits</th>
          <th>Porgram</th>
        <th>Whether newly introduced during assessment year(yes/no)</th>
    ...
    <?php while ($row = mysqli_fetch_assoc($r)) : ?>
        <tr>
            ...
            <td><strong><?php echo $row['lecture_h']; ?></strong></td>
            <td><strong><?php echo $row['tutorial_h']; ?></strong></td>
            <td><strong><?php echo $row['practical_h']; ?></strong></td>
            <td><strong><?php echo $row['credits_h']; ?></strong></td>
             <td><strong><?php echo $row['program']; ?></strong></td>
              <td><strong><?php echo $row['options']; ?></strong></td>

            
           
            <td><form method="POST" style="display: inline;" action="course_edit.php">
