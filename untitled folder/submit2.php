   ...
   if (mysqli_connect_error()) {
     ...
     //}
             ...
             // File upload is successful, move the uploaded file to the desired location
                 ...
                 $q = "UPDATE student.objective SET id = '$id', vision = '$vision', mission = '$mission', core_values = '$core_values'  WHERE id = '$hidden_id'";
                 $r = mysqli_query($conn1ssss, $q);
                 $q1 = "UPDATE nba.objective SET id = '$id', vision = '$vision', mission = '$mission'  WHERE id = '$hidden_id'";
