...
if (mysqli_connect_error()) {
    ...
    $q = "DELETE FROM certificate  WHERE id='$deleteid'";
...
$l = "select *from certificate";
$r = mysqli_query($conn, $l);
?>
<h5 style="color: #00BFFF;">1.3.2.1: How many add on/certificate/value added program/Diploma Programs/ online courses of MOOCS/SWAYAM/e Patashala/ NPTEL etc (without repeat count) where the students of the institution have enrolled and benefitted</h5>

<div class="t">
<table id="myTable">
    <tr>
        <th>id</th>
        <th>Name of the add on/certificate/value added program/Diploma Programs/ onlinecourse of MOOCS/SWAYAM/e Patashala/ NPTEL etc</th>
        <th>Program duration(No of contact Hours)</th>
        <th>Number of students benfitted through the program</th>
    ...
    <?php while ($row = mysqli_fetch_assoc($r)) : ?>
        <tr>
            ...
            <td><strong><?php echo $row['hour']; ?></strong></td>
            <td><strong><?php echo $row['total']; ?></strong></td>
            
           
            <td><form method="POST" style="display: inline;" action="nedit.php">
...
<form method="post" action="ncreate.php">
