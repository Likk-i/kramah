...
if (mysqli_connect_error()) {
    ...
    $q = "DELETE FROM nba.institute_info WHERE institute_info.id='$deleteid'";
...
<table id="myTable">
    ...
    <?php while ($row = mysqli_fetch_assoc($r)) : ?>
        <tr>
            ...
            <td><strong><?php echo $row['year_of_establishment']; ?></strong></td>
            <td><strong><?php echo $row['type_of_institute']; ?></strong></td>
            <td><strong><?php echo $row['ownership_status']; ?></strong></td>
           
            <td><form method="POST" style="display: inline;" action="edit3.php">
...
<form method="post" action="button3.php">
